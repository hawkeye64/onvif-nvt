...
describe('Media', () => {
  ...
  test('Camera.media.getVideoSources', () => {
  ...
  test('Camera.media.getVideoSourceConfigurations', () => {
  ...
  test('Camera.media.getVideoEncoderConfigurations', () => {
  ...
  test('Camera.media.getAudioSources', () => {
  ...
  test('Camera.media.getAudioSourceConfigurations', () => {
  ...
  test('Camera.media.getAudioEncoderConfigurations', () => {
  ...
  test('Camera.media.getVideoAnalyticsConfigurations', () => {
  ...
  test('Camera.media.getMetadataConfigurations', () => {
