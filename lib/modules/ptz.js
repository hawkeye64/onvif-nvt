 ...
 * </p>
 * <h3>Functions</h3>
 * {@link Ptz#getNodes},{@link Ptz#getNode}, {@link Ptz#getConfigurations}, {@link Ptz#getConfiguration},
 * {@link Ptz#getConfigurationOptions}, {@link Ptz#setConfiguration}, {@link Ptz#getCompatibleConfigurations},
 * {@link Ptz#absoluteMove}, {@link Ptz#relativeMove}, {@link Ptz#continuousMove},{@link Ptz#geoMove},
 * {@link Ptz#stop}, {@link Ptz#getStatus}, {@link Ptz#getStatus}, {@link Ptz#setPreset},
 * {@link Ptz#getPresets}, {@link Ptz#gotoPreset}, {@link Ptz#removePreset},
 * {@link Ptz#gotoHomePosition}, {@link Ptz#setHomePosition}, {@link Ptz#sendAuxiliaryCommand}
 * <br><br>
 * <h3>Overview</h3>
...
class Ptz {
  ...
  getGenericRequest (methodName, callback) {
    let promise = new Promise((resolve, reject) => {
      let soapBody = `<tptz:${methodName}/>`
   ...
   */
  getNodes (callback) {
    return this.getGenericRequest('GetNodes', callback)
  }
  ...
  getNode (nodeToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'GetNode', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getConfigurations (callback) {
    return this.getGenericRequest('GetConfigurations', callback)
  }
  ...
  getConfiguration (configurationToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'GetConfiguration', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getConfigurationOptions (configurationToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'GetConfigurationOptions', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getCompatibleConfigurations (profileToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'GetCompatibleConfigurations', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  absoluteMove (profileToken, position, speed, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'AbsoluteMove', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  relativeMove (profileToken, translation, speed, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'RelativeMove', soapEnvelope)
        .then(results => {
          resolve(results)
        })
        .catch(error => {
  ...
  continuousMove (profileToken, velocity, timeout, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'ContinuousMove', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  geoMove (profileToken, geoLocation, speed, areaWidth, areaHeight, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'GeoMove', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  stop (profileToken, panTilt, zoom, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'Stop', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getStatus (profileToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'GetStatus', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
   ...
   * ONVIF™ – 17 – PTZ Spec. – Ver. 17.12<br>
  ...
  setPreset (profileToken, presetToken, presetName, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'SetPreset', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getPresets (profileToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'GetPresets', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  gotoPreset (profileToken, presetToken, speed, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'GotoPreset', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  removePreset (profileToken, presetToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'RemovePreset', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  gotoHomePosition (profileToken, speed, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'GotoHomePosition', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  setHomePosition (profileToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest(this.serviceAddress, 'SetHomePosition', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  sendAuxiliaryCommand (profileToken, auxiliaryData, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      if ((errMsg = Util.isInvalidValue(auxiliaryData, 'string'))) {
        reject(new Error('The "profileauxiliaryDataToken" argument for sendAuxiliaryCommand is invalid: ' + errMsg))
        return
      }

      let soapBody = ''
      soapBody += '<tptz:SendAuxiliaryCommand>'
      soapBody += '<tptz:ProfileToken>' + profileToken + '</tptz:ProfileToken>'
