...
class Media2 {
  ...
  getProfiles () {
    return new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest('media2', this.serviceAddress, 'GetProfiles', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getSnapshotUri (profileToken) {
    return new Promise((resolve, reject) => {
      ...
      soapBody += '</trt:GetSnapshotUri>'
      let soapEnvelope = this.createRequest(soapBody)
      return Soap.makeRequest('media2', this.serviceAddress, 'GetSnapshotUri', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
