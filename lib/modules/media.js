...
class Media {
  ...
  deleteProfile (profileToken, callback) {
    let promise = new Promise((resolve, reject) => {
      let errMsg = ''
      if ((errMsg = Util.isInvalidValue(profileToken, 'string'))) {
        reject(new Error('The "profileToken" argument for deleteProfile is invalid: ' + errMsg))
        return
      }
      ...
      this.buildRequest('DeleteProfile', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getVideoSourceConfiguration (configurationToken, callback) {
    let promise = new Promise((resolve, reject) => {
      let errMsg = ''
      if ((errMsg = Util.isInvalidValue(configurationToken, 'string'))) {
        reject(new Error('The "configurationToken" argument for getVideoSourceConfiguration is invalid: ' + errMsg))
        return
      }
      ...
      this.buildRequest('GetVideoSourceConfiguration', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getCompatibleVideoSourceConfigurations (profileToken, callback) {
    let promise = new Promise((resolve, reject) => {
      let errMsg = ''
      if ((errMsg = Util.isInvalidValue(profileToken, 'string'))) {
        reject(new Error('The "profileToken" argument for getCompatibleVideoSourceConfigurations is invalid: ' + errMsg))
        return
      }
      ...
      this.buildRequest('GetCompatibleVideoSourceConfigurations', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getVideoSourceConfigurationOptions (profileToken, configurationToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      if (typeof profileToken !== 'undefined' && profileToken !== null) {
        if ((errMsg = Util.isInvalidValue(profileToken, 'string'))) {
          reject(new Error('The "profileToken" argument for getVideoSourceConfigurationOptions is invalid: ' + errMsg))
          return
        }
      }
      if (typeof configurationToken !== 'undefined' && configurationToken !== null) {
        if ((errMsg = Util.isInvalidValue(configurationToken, 'string'))) {
          reject(new Error('The "configurationToken" argument for getVideoSourceConfigurationOptions is invalid: ' + errMsg))
          return
        }
      }
      ...
      this.buildRequest('GetVideoSourceConfigurationOptions', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getVideoEncoderConfiguration (configurationToken, callback) {
    let promise = new Promise((resolve, reject) => {
      let errMsg = ''
      if ((errMsg = Util.isInvalidValue(configurationToken, 'string'))) {
        reject(new Error('The "configurationToken" argument for getVideoEncoderConfiguration is invalid: ' + errMsg))
        return
      }
      ...
      this.buildRequest('GetVideoEncoderConfiguration', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getCompatibleVideoEncoderConfigurations (profileToken, callback) {
    let promise = new Promise((resolve, reject) => {
      let errMsg = ''
      if ((errMsg = Util.isInvalidValue(profileToken, 'string'))) {
        reject(new Error('The "ProfileToken" argument for getCompatibleVideoEncoderConfigurations is invalid: ' + errMsg))
        return
      }
      ...
      this.buildRequest('GetCompatibleVideoEncoderConfigurations', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getVideoEncoderConfigurationOptions (profileToken, configurationToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      if (typeof profileToken !== 'undefined' && profileToken !== null) {
        if ((errMsg = Util.isInvalidValue(profileToken, 'string'))) {
          reject(new Error('The "ProfileToken" argument for getVideoEncoderConfigurationOptions is invalid: ' + errMsg))
          return
        }
      }
      if (typeof configurationToken !== 'undefined' && configurationToken !== null) {
        if ((errMsg = Util.isInvalidValue(configurationToken, 'string'))) {
          reject(new Error('The "configurationToken" argument for getVideoEncoderConfigurationOptions is invalid: ' + errMsg))
          return
        }
      }
  ...
  getGuaranteedNumberOfVideoEncoderInstances (configurationToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      this.buildRequest('GetGuaranteedNumberOfVideoEncoderInstances', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getMetadataConfiguration (configurationToken, callback) {
    let promise = new Promise((resolve, reject) => {
      let errMsg = ''
      if ((errMsg = Util.isInvalidValue(configurationToken, 'string'))) {
        reject(new Error('The "configurationToken" argument for getMetadataConfiguration is invalid: ' + errMsg))
        return
      }
      ...
      this.buildRequest('GetMetadataConfiguration', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getCompatibleMetadataConfigurations (profileToken, callback) {
    let promise = new Promise((resolve, reject) => {
      let errMsg = ''
      if ((errMsg = Util.isInvalidValue(profileToken, 'string'))) {
        reject(new Error('The "profileToken" argument for getCompatibleMetadataConfigurations is invalid: ' + errMsg))
        return
      }
      ...
      this.buildRequest('GetCompatibleMetadataConfigurations', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getMetadataConfigurationOptions (profileToken, configurationToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      if (typeof profileToken !== 'undefined' && profileToken !== null) {
        if ((errMsg = Util.isInvalidValue(profileToken, 'string'))) {
          reject(new Error('The "profileToken" argument for getMetadataConfigurationOptions is invalid: ' + errMsg))
          return
        }
      }
      if (typeof configurationToken !== 'undefined' && configurationToken !== null) {
        if ((errMsg = Util.isInvalidValue(configurationToken, 'string'))) {
          reject(new Error('The "configurationToken" argument for getMetadataConfigurationOptions is invalid: ' + errMsg))
          return
        }
      }
      ...
      this.buildRequest('GetMetadataConfigurationOptions', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
