...
class Media {
  ...
  getProfiles (callback) {
    return this.getGenericRequest('GetProfiles', callback)
  }
  ...
  getProfile (profileToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      let soapBody = '<trt:GetProfile>'
      soapBody += '<trt:ProfileToken>' + profileToken + '</trt:ProfileToken>'
      soapBody += '</trt:GetProfile>'
      let soapEnvelope = this.createRequest(soapBody)

      return Soap.makeRequest(this.serviceAddress, 'GetProfile', soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getVideoSources (callback) {
    return this.getGenericRequest('GetVideoSources', callback)
  }
  ...
  getVideoSourceConfigurations (callback) {
    return this.getGenericRequest('GetVideoSourceConfigurations', callback)
  }
  ...
  getVideoEncoderConfigurations (callback) {
    return this.getGenericRequest('GetVideoEncoderConfigurations', callback)
  }
  ...
  getAudioSources (callback) {
    return this.getGenericRequest('GetAudioSources', callback)
  }
  ...
  getAudioSourceConfigurations (callback) {
    return this.getGenericRequest('GetAudioSourceConfigurations', callback)
  }
  ...
  getAudioEncoderConfigurations (callback) {
    return this.getGenericRequest('GetAudioEncoderConfigurations', callback)
  }
  ...
  getVideoAnalyticsConfigurations (callback) {
    return this.getGenericRequest('GetVideoAnalyticsConfigurations', callback)
  }
  ...
  getMetadataConfigurations (callback) {
    return this.getGenericRequest('GetMetadataConfigurations', callback)
  }
  ...
  getAudioOutputs (callback) {
    return this.getGenericRequest('GetAudioOutputs', callback)
  }
  ...
  getAudioOutputConfigurations (callback) {
    return this.getGenericRequest('GetAudioOutputConfigurations', callback)
  }
  ...
  getAudioDecoderConfigurations (callback) {
    return this.getGenericRequest('GetAudioDecoderConfigurations', callback)
  }
