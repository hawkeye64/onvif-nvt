...
class Media {
  ...
  buildRequest (methodName, xml, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      return Soap.makeRequest('media', this.serviceAddress, methodName, soapEnvelope)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getVideoSourceModes (videoSourceToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      this.buildRequest('GetVideoSourceModes', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  deleteOSD (OSDToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      this.buildRequest('DeleteOSD', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getOSDs (configurationToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      this.buildRequest('GetOSDs', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
  ...
  getOSD (OSDToken, callback) {
    let promise = new Promise((resolve, reject) => {
      ...
      this.buildRequest('GetOSD', soapBody)
        .then(results => {
          resolve(results)
        }).catch(error => {
          reject(error)
